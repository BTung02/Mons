...
LoreleiData:
	...
	db 77,GLACEON
	moveset ICE_BEAM, SHEER_COLD, IRON_TAIL, HEADBUTT 
	db $FF
...
BrunoData:
	...
	db 77,HITMONCHAN
	moveset SHADOW_PUNCH, SUCKER_PUNCH, THUNDER_PUNCH, DYNAMICPUNCH
	...
	db 79,HERACROSS
	moveset X_SCISSOR, CROSS_CHOP, COUNTER, AERIAL_ACE
	db $FF
...
AgathaData:
	...
	db 80,HOUNDOOM
	moveset SHADOW_BALL, FLAMETHROWER, HEX, DARK_PULSE
	...
	db 79,UMBREON
	moveset CONFUSE_RAY, MOONLIGHT, PROTECT, CRUNCH
	db $FF
...
LanceData:
	...
	db 80,GYARADOS
	moveset DRAGONBREATH, THRASH, WATERFALL, ICE_FANG
	
	db 80,CHARIZARD
	moveset BLAST_BURN, DRAGONBREATH, AERIAL_ACE, METAL_CLAW
	
	db 79,KINGDRA
	moveset SURF, DRAGON_PULSE, FOCUS_ENERGY, HYPER_BEAM
	
	db 80,AERODACTYL
	moveset ANCIENTPOWER, ACROBATICS, DRAGONBREATH, EARTHQUAKE
	
	db 81,DRAGONITE
	moveset DRACO_METEOR, THUNDER_WAVE, HURRICANE, AMNESIA

	db 80,DRACOGEIST
	moveset OUTRAGE, DRAGON_DANCE, FIRE_PUNCH, SHADOW_CLAW
	db $FF	
...
Green3Data:
	...
	db 79,ALAKAZAM
	moveset PSYCHIC_M, SHADOW_BALL, DAZZLING_GLEAM, RECOVER
	
	db 80,RHYPERIOR
	moveset EARTHQUAKE, MEGAHORN, ROCK_BLAST, TAKE_DOWN
	
	db 80,ARCANINE
	moveset EXTREMESPEED, CRUNCH, FLARE_BLITZ, EARTHQUAKE
...
AceTrainerMData: ; COMPLETED
	...
	db "BRETT@“,63,GENGAR,NIDOKING,STEELIX,$FF ; VICTORYROAD 3 BL
